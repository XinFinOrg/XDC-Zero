...
function exportSubswap(){
  ...
  console.log("SUCCESS deploy subswap. Before register application step, please include the following into your .env ")
...
function writeSubswapDeployJson(){ 
  ...
  fs.writeFileSync('../applications/subswap/contract/deploy.config.json', JSON.stringify(deployJson, null, 2) , 'utf-8', err => {
    if (err) {
